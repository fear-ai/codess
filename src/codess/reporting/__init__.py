...
Four facilities without a contract became one: status printing, progress
tracing, logger calls, and exception rendering each decided their own
...
without an import cycle. `privacy` imports `hashing` for a truncated digest
and nothing else.
