...
| **C. Fix later** | Accepted, unblocked, not started. Grouped and ordered below. | W04, W07, W08, W09, W12, W13, W14, W15, W18, W19, W21, W24, W28, W31, W32, W37, W38, W39, W41, W42 |
...
| Rank | Group | Why here |
|---|---|---|
| 1 | **1. Decode correctness** (W37 → W39 → W12) | Its failure mode is silently wrong data, which every other group builds on and none of them detects. A reporting contract over a wrong decode reports wrongly, on schedule. W39.1 closed this pass, so what remains is the coverage sweep's tail and the loss report. |
