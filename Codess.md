...
Vendor and provider are separate dimensions, and conflating them is a recorded
defect rather than a hypothetical: a harness commonly engages models from
providers other than its own vendor.
